...
<div class="container my-5">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="card mt-4">
                <div class="card-body">
                    <a href="#" class="btn btn-primary w-100">売上管理</a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card mt-4">
                <div class="card-body">
                    <a href="#" class="btn btn-primary w-100">会社情報管理</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var salesData = {
        ...
        datasets: [{
            ...
            data: [12000, 19000, 3000, 5000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000]
        }]
    };
